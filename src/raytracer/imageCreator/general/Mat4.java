...
public final class Mat4
{
	...
	{
		return rotate(new Vec3(1, 0, 0), angle);
	}

	public static Mat4 rotateY( double angle )
	{
		return rotate(new Vec3(0, 1, 0), angle);
	}

	public static Mat4 rotateZ( double angle )
	{
		return rotate(new Vec3(0, 0, 1), angle);
	}
	...
	public Vec3 transformNormal( Vec3 v )
	{
		...
		return selfmadeTransformNormal(v);
	}

	private Vec3 selfmadeTransformNormal( Vec3 v )
	{
		Mat4 invert = invertFull();
		invert = invert.transpose();
		return invert.transformDirection(v);
	}
